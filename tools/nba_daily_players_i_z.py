...
def P(pid, name, retired, from_year, to_year, draft_team, teams, tier,
    ...
    return {
        ...
        "funFact": fun_fact,
        "headshotUrl": headshot_url if headshot_url else bbr_headshot(name),
...
PLAYERS = [
    ...
    P(101571, "Serge Ibaka", True, 2009, 2022, "Oklahoma City Thunder",
        ...
        championships=1),
    P(980, "Zydrunas Ilgauskas", True, 1996, 2010, "Cleveland Cavaliers",
    ...
    P(101127, "Joe Johnson", True, 2001, 2018, "Boston Celtics",
        ...
        all_star_count=7),
    P(1628991, "Jaren Jackson Jr.", False, 2018, None, "Memphis Grizzlies",
        ["Memphis Grizzlies"],
        ...
        dpoy_count=1),
    P(201599, "DeAndre Jordan", True, 2008, 2023, "Los Angeles Clippers",
        ...
        all_star_count=1),
    P(1630552, "Jalen Johnson", False, 2021, None, "Atlanta Hawks",
        ["Atlanta Hawks"],
    ...
    P(1628371, "Jonathan Isaac", False, 2017, None, "Orlando Magic",
        ["Orlando Magic"],
    ...
    P(1628973, "Jalen Brunson", False, 2018, None, "Dallas Mavericks",
    ...
    P(467, "Jason Kidd", True, 1994, 2013, "Dallas Mavericks",
    ...
    P(1628398, "Kyle Kuzma", False, 2017, None, "Los Angeles Lakers",
    ...
    P(2616, "Andrei Kirilenko", True, 2001, 2015, "Utah Jazz",
        ...
        all_star_count=1),
    P(1628368, "De'Aaron Fox", False, 2017, None, "Sacramento Kings",
        ["Sacramento Kings"],
    ...
    P(1629029, "Luka Doncic", False, 2018, None, "Dallas Mavericks",
    ...
    P(1629637, "Tyler Herro", False, 2019, None, "Miami Heat",
        ...
        sixmoy_count=1),
    P(202391, "Jeremy Lin", True, 2010, 2019, "Golden State Warriors",
        ...
        championships=1),
    P(1628374, "Lauri Markkanen", False, 2017, None, "Chicago Bulls",
    ...
    P(397, "Reggie Miller", True, 1987, 2005, "Indiana Pacers",
        ["Indiana Pacers"],
    ...
    P(1628378, "Donovan Mitchell", False, 2017, None, "Utah Jazz",
    ...
    P(1628370, "Malik Monk", False, 2017, None, "Charlotte Hornets",
    ...
    P(1629008, "Michael Porter Jr.", False, 2019, None, "Denver Nuggets",
        ["Denver Nuggets"],
    ...
    P(202693, "Markieff Morris", False, 2011, None, "Phoenix Suns",
    ...
    P(1717, "Dirk Nowitzki", True, 1998, 2019, "Dallas Mavericks",
        ["Dallas Mavericks"],
    ...
    P(1628384, "OG Anunoby", False, 2017, None, "Toronto Raptors",
    ...
    P(1631094, "Paolo Banchero", False, 2022, None, "Orlando Magic",
        ["Orlando Magic"],
    ...
    P(200765, "Rajon Rondo", True, 2006, 2022, "Boston Celtics",
    ...
    P(203944, "Julius Randle", False, 2014, None, "Los Angeles Lakers",
    ...
    P(1629628, "RJ Barrett", False, 2019, None, "New York Knicks",
    ...
    P(1628983, "Shai Gilgeous-Alexander", False, 2018, None, "Los Angeles Clippers",
    ...
    P(1629014, "Anfernee Simons", False, 2018, None, "Portland Trail Blazers",
    ...
    P(202738, "Isaiah Thomas", True, 2011, 2022, "Sacramento Kings",
    ...
    # T
    # ════════════════════════════════════════════════
    P(1626157, "Karl-Anthony Towns", False, 2015, None, "Minnesota Timberwolves",
    ...
    # V
    # ════════════════════════════════════════════════
    P(202696, "Nikola Vucevic", False, 2011, None, "Philadelphia 76ers",
        ...
        all_star_count=2),
    P(202685, "Jonas Valanciunas", False, 2012, None, "Toronto Raptors",
    ...
    P(101114, "Deron Williams", True, 2005, 2017, "Utah Jazz",
    ...
    P(200755, "Kemba Walker", True, 2011, 2023, "Charlotte Bobcats",
        ...
        all_star_count=4),
    P(1641705, "Victor Wembanyama", False, 2023, None, "San Antonio Spurs",
        ["San Antonio Spurs"],
    ...
    P(202322, "John Wall", False, 2010, None, "Washington Wizards",
    ...
    P(1629023, "P.J. Washington", False, 2019, None, "Charlotte Hornets",
    ...
    # ════════════════════════════════════════════════
    P(1630162, "Anthony Edwards", False, 2020, None, "Minnesota Timberwolves",
        ...
        all_star_count=3, signature_shoe_brand="Adidas"),
    P(1631096, "Chet Holmgren", False, 2023, None, "Oklahoma City Thunder",
    ...
    P(203078, "Bradley Beal", False, 2012, None, "Washington Wizards",
        ...
        all_star_count=3),
    P(202704, "Reggie Jackson", False, 2011, None, "Oklahoma City Thunder",
    ...
    P(1630193, "Immanuel Quickley", False, 2020, None, "New York Knicks",
        ["New York Knicks", "Toronto Raptors"],
    ...
    P(1628970, "Miles Bridges", False, 2018, None, "Charlotte Hornets",
        ["Charlotte Hornets"],
    ...
    P(1630178, "Tyrese Maxey", False, 2020, None, "Philadelphia 76ers",
        ["Philadelphia 76ers"],
    ...
    P(1630169, "Tyrese Haliburton", False, 2020, None, "Sacramento Kings",
    ...
    P(1630228, "Evan Mobley", False, 2021, None, "Cleveland Cavaliers",
        ...
        all_star_count=1),
    P(1628969, "Mikal Bridges", False, 2018, None, "Phoenix Suns",
    ...
    P(1631095, "Jabari Smith Jr.", False, 2022, None, "Houston Rockets",
        ["Houston Rockets"],
        "solid", 170, 5240, "PF", "6-10", ["10"],
        college="Auburn", draft_year=2022, draft_round=1, draft_pick=3,
        headshot_url=f"{BBR_HEADSHOT_BASE}/smithja05.jpg"),
    P(1629629, "Cam Reddish", False, 2019, None, "Atlanta Hawks",
    ...
    P(1629134, "Kendrick Nunn", False, 2019, None, "Miami Heat",
